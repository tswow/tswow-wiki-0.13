...
NECROMANCY_TRAINER_HUMAN.Trainer.addSpell(DEATH_BOLT.ID,10,0,DEATH_SKILL.ID,0,[]);
NECROMANCY_TRAINER_HUMAN.Trainer.addSpell(SUMMON_ABOMINATION.ID,10,5,NECROMANCY_SKILL.ID,0,[]);
NECROMANCY_TRAINER_HUMAN.Trainer.addSpell(BONE_SHIELD.ID,10,10,NECROMANCY_SKILL.ID,0,[]);
```
